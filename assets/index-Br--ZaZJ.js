 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Nh=P.forwardRef(({color:o="currentColor",size:a=24,strokeWidth:l=2,absoluteStrokeWidth:c,className:f="",children:k,iconNode:y,..._},S)=>P.createElement("svg",{ref:S,...Rh,width:a,height:a,stroke:o,strokeWidth:c?Number(l)*24/Number(a):l,className:Qd("lucide",f),..._},[...y.map(([C,N])=>P.createElement(C,N)),...Array.isArray(k)?k:[k]]));/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
